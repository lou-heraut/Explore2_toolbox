...
``` 
git clone https://github.com/lou-heraut/Explore2_toolbox
```

Ou alors en le téléchargeant en *zip* avec le lien suivant [Explore2_toolbox-main.zip](https://github.com/lou-heraut/Explore2_toolbox/archive/refs/heads/main.zip).
...
Si vous voulez utiliser ce processu de création de NetCDF dans un autre contexte et de manière plus fine, vous pouvez trouver l'ensemble de la documentation du package R [NCf sur sa page github associée](https://github.com/lou-heraut/NCf).
